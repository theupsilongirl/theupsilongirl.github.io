...
[...document.querySelectorAll(".socials")].forEach((element)=>{
	if(element.getAttribute("href")) element.addEventListener("click",(e)=>{
		e.preventDefault();
		window.open("https://www.youtube.com/watch?v=dQw4w9WgXcQ")
	})
	else if(element.getAttribute("action")) element.addEventListener("submit",(e)=>{
		e.preventDefault();
		window.open("https://www.youtube.com/watch?v=dQw4w9WgXcQ")
	})
})